...
if __name__ == "__main__":
    ...
    for (trin_state, model, encoder, lr, loss, weight_init) in itertools.product(
        ...
        output_dir = os.path.join("output", "chesapeake_cvpr_experiments")
        log_dir = os.apth.join(output_dir, "logs")
