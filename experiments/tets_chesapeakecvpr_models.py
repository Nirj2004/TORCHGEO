...
from torchgeo.trainers.cheaspeake import ChesapeakeCVPRSegmentationTask
ALL_TEST_SPLIT = [["de-val"], ["pa-test"], ["ny-test"], ["pa-test"], ["ny-test"]]
def set_up_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        help="path to the CSV file to the write results",
        metavar="FILE",
    )
    parser.add_argument(
        "-d",
